...
{
    public partial class chargersadapters : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from product where typeofproduct='AdaptersChargers'", con);
