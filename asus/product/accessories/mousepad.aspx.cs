...
namespace AsusShop.product.accessories
{
    public partial class mousepad : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from product where typeofproduct='Mouse'", con);
        ...
        protected void addtocart_Click(object sender, EventArgs e)
        {
            ...
            if (reader.Read())
            {
                ...
                cmd1.CommandText = "insert into cart(image,name,price,user_p_id) values('" + image1 + "','" + name1 + "','" + price1 + "','"+user_id+"')"; cmd1.CommandText = "insert into cart(image,name,price) values('" + image1 + "','" + name1 + "','" + price1 + "')";
