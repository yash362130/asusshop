...
namespace AsusShop.product.networking_server
{
    public partial class wireless_wireadpeters : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from product where typeofproduct='adapters' ", con);
        ...
        protected void addtocart_Click(object sender, EventArgs e)
        {
            ...
            if (reader.Read())
            {
                ...
                cmd1.CommandText = "insert into cart(image,name,price,user_p_id) values('" + image1 + "','" + name1 + "','" + price1 + "','" + user_id + "')"; cmd1.ExecuteNonQuery();
                con.Close();
            }
        }
    }
