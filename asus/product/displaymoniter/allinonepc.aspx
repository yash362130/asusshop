<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeBehind="allinonepc.aspx.cs" Inherits="AsusShop.displaymoniter.allinonepc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Image ID="Image1" runat="server" CssClass="cartimage" ImageUrl="../../image/addtocart.png" Visible="false" />
