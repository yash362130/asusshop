...
namespace AsusShop.displaymoniter
{
    public partial class gamingtowerpc : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from product where typeofproduct='GamongTowerPc' ", con);
