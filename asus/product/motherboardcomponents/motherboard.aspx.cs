...
namespace AsusShop.product.motherboard
{
    public partial class powersupplyunits : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from product where typeofproduct='MotherBoard' ", con);
