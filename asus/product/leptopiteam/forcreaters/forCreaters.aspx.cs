...
namespace AsusShop.leptopiteam
{
    public partial class forcreters : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from product where typeofproduct='ForCreators'", con);
